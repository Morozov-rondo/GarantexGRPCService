...
const (
	Rates_Get_FullMethodName = "/garantexGRPC.Rates/Get"
)
...
func (c *ratesClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, Rates_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRatesServer) Get(context.Context, *GetRequest) (*GetResponse, error) {
...
func _Rates_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RatesServer).Get(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Rates_Get_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RatesServer).Get(ctx, req.(*GetRequest))
	}
...
var Rates_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "garantexGRPC.Rates",
	HandlerType: (*RatesServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Get",
			Handler:    _Rates_Get_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "garantex.proto",
}
